...
import static org.quantitymeasurement.uc7.QuantityMeasurementApp.demonstrateLengthAddition;
...
public class QuantityMeasurementAppTest {
    ...
    public void testAdditionExpliciteTargetUnitFeet(){
        Length length1 = new Length(1.0, Length.LengthUnit.FEET);
        Length length2 = new Length(12.0, Length.LengthUnit.INCHES);
        Length addLength = demonstrateLengthAddition(length1,length2, Length.LengthUnit.FEET);
    ...
    public void testAdditionExpliciteTargetUnitInches(){
        Length length1 = new Length(1.0, Length.LengthUnit.FEET);
        Length length2 = new Length(12.0, Length.LengthUnit.INCHES);
        Length addLength = demonstrateLengthAddition(length1,length2, Length.LengthUnit.INCHES);
    ...
    public void testAdditionExpliciteTargetUnitYards(){
        Length length1 = new Length(1.0, Length.LengthUnit.FEET);
        Length length2 = new Length(12.0, Length.LengthUnit.INCHES);
        Length addLength = demonstrateLengthAddition(length1,length2, Length.LengthUnit.YARDS);
    ...
    public void testAdditionExpliciteTargetUnitCentimeters(){
        Length length1 = new Length(1.0, Length.LengthUnit.INCHES);
        Length length2 = new Length(1.0, Length.LengthUnit.INCHES);
        Length addLength = demonstrateLengthAddition(length1,length2, Length.LengthUnit.CENTIMETERS);
        assertEquals(5.08,addLength.getValue());
        assertEquals(Length.LengthUnit.CENTIMETERS,addLength.getUnit());
    }
    ...
    public void testAdditionExpliciteTargetUnitCommutativity(){
        Length length1 = new Length(1.0, Length.LengthUnit.FEET);
        Length length2 = new Length(12.0, Length.LengthUnit.INCHES);
        Length addLength1 = demonstrateLengthAddition(length1,length2, Length.LengthUnit.YARDS);
        Length addLength2 = demonstrateLengthAddition(length2,length1, Length.LengthUnit.YARDS);
    ...
    public void testAdditionExpliciteTargetUnitSmallToLargeScale(){
        Length length1 = new Length(12.00, Length.LengthUnit.INCHES);
        Length length2 = new Length(12.00, Length.LengthUnit.INCHES);
        Length addLength = demonstrateLengthAddition(length1,length2, Length.LengthUnit.YARDS);
        assertEquals(0.667,addLength.getValue());
        assertEquals(Length.LengthUnit.YARDS,addLength.getUnit());
    }
    ...
    public void testAdditionExpliciteTargetUnitAllUnitCombinations(){
        ...
        Length length2 = new Length(12.00, Length.LengthUnit.INCHES);
        Length addLength1 = demonstrateLengthAddition(length1,length2, Length.LengthUnit.YARDS);
        Length addLength2 = demonstrateLengthAddition(length1,length2, Length.LengthUnit.INCHES);
        Length addLength3 = demonstrateLengthAddition(length1,length2, Length.LengthUnit.CENTIMETERS);
        Length addLength4 = demonstrateLengthAddition(length1,length2, Length.LengthUnit.FEET);
        assertEquals(0.667,addLength1.getValue());
        assertEquals(Length.LengthUnit.YARDS,addLength1.getUnit());
        assertEquals(24.0,addLength2.getValue());
        assertEquals(Length.LengthUnit.INCHES,addLength2.getUnit());
        assertEquals(60.96,addLength3.getValue());
        assertEquals(Length.LengthUnit.CENTIMETERS,addLength3.getUnit());
        assertEquals(2.0,addLength4.getValue());
        assertEquals(Length.LengthUnit.FEET,addLength4.getUnit());
    }
